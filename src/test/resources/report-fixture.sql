...
VALUES (1, '2023-11-11 00:00:00', '아직 신고안된 댓글이야', 'ACTIVE', 1);

INSERT INTO cheer_talks (id, created_at, content, block_status, game_team_id)
VALUES (2, '2023-11-11 00:00:00', '이미 블락된 댓글이야', 'BLOCKED_BY_ADMIN', 1);

INSERT INTO cheer_talks (id, created_at, content, block_status, game_team_id)
VALUES (3, '2023-11-11 00:00:00', '이미 신고된 댓글이야', 'ACTIVE', 1),
       (4, '2023-11-11 00:00:00', '신고 확인 대기 중인 댓글이야', 'ACTIVE', 1);
