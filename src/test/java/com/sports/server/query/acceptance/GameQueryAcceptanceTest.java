        ...
        assertAll(
                ...
                () -> assertThat(teams)
                        ...
                        .containsExactly(new GameDetailResponse.TeamResponse(
                                1L, 1L, "팀 A",
                                "http://example.com/logo_a.png", 1, 0, "#FF0000")
                        ),
                () -> assertThat(teams)
                        .filteredOn(team -> team.gameTeamId().equals(2L))
                        .containsExactly(new GameDetailResponse.TeamResponse(
                                2L, 2L, "팀 B",
                                "http://example.com/logo_b.png", 2, 0, "#0000FF")
                        ),
                ...
                () -> assertThat(games)
                        ...
                        .containsExactly(
                                new GameResponseDto(
                                        ...
                                        new QuarterResponse("PRE_GAME", "경기전"), "축구 대전", 4, false, "abc123", "SCHEDULED",
                ...
                () -> assertThat(games)
                        ...
                        .containsExactly(
                                new GameResponseDto(
                                        ...
                                        new QuarterResponse("PRE_GAME", "경기전"), "두번째로 빠른 경기", 4, false, "abc123", "SCHEDULED",
                                        List.of(new GameResponseDto.TeamResponse(
