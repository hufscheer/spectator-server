...
import static com.sports.server.command.comment.exception.CheerTalkErrorMessages.CHEER_TALK_CONTAINS_BAD_WORD;

import com.sports.server.command.comment.domain.CheerTalk;
import com.sports.server.command.comment.domain.CheerTalkRepository;
