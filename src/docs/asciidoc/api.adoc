...
operation::game-controller-test/게임팀_라인업에서_선수를_삭제한다[snippets='http-request,path-parameters,http-response']

=== 라인업 선수 선발로 변경

operation::game-controller-test/라인업_선수의_상태를_선발로_변경한다[snippets='http-request,path-parameters,http-response']

=== 라인업 선수 후보로 변경

operation::game-controller-test/라인업_선수의_상태를_후보로_변경한다[snippets='http-request,path-parameters,http-response']

=== 라인업 선수 주장으로 등록

operation::game-controller-test/라인업_선수를_주장으로_등록한다[snippets='http-request,path-parameters,http-response']

=== 라인업 선수 주장에서 해제

operation::game-controller-test/라인업_선수를_주장에서_해제한다[snippets='http-request,path-parameters,http-response']
...
operation::league-query-controller-test/최근_리그의_게임_목록을_조회한다[snippets='http-request,http-response,response-fields']
...
operation::nl-controller-test/팀_컨텍스트_없이_선수_정보를_파싱한다[snippets='http-request,request-fields,http-response,response-fields']
...
operation::nl-controller-test/학번_중복_여부를_확인한다[snippets='http-request,request-fields,http-response,response-fields']
