...
operation::cheer-talk-query-controller-test/모든_차단되지_않은_응원톡을_조회한다[snippets='http-request,request-cookies,query-parameters,http-response,response-fields']

=== 모든 차단된 응원톡 조회

operation::cheer-talk-query-controller-test/모든_차단된_응원톡을_조회한다[snippets='http-request,request-cookies,query-parameters,http-response,response-fields']
...
operation::cheer-talk-controller-test/응원톡을_차단한다[snippets='http-request,request-cookies,path-parameters,http-response']

=== 응원톡을 가리기 취소하기

operation::cheer-talk-controller-test/응원톡_차단을_해제한다[snippets='http-request,request-cookies,path-parameters,http-response']
